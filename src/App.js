    ...
    >
      ...
      <div className="min-h-screen bg-warm-beige text-rich-brown">
                ...
                <>
                  ...
                  <div className="relative overflow-hidden bg-gradient-to-br from-warm-beige via-white to-soft-green bg-opacity-90">
                    ...
                    <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center relative z-10">
                      <div className="md:w-1/2 md:pr-12 mb-10 md:mb-0 z-10 animate-fadeIn">
                        {/* Badge */}
                        <div className="inline-block px-4 py-2 rounded-full bg-golden-yellow bg-opacity-20 text-golden-yellow font-semibold text-sm mb-6 animate-bounce-subtle">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold text-rich-brown mb-6 leading-tight">
                      ...
                      {/* Hero Image Section */}
                      <div className="md:w-1/2 relative z-10 animate-fadeIn">
                        {/* Main product image with floating effect */}
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl mx-auto max-w-md transform hover:rotate-0 transition-all duration-500 hover:shadow-golden animate-float-subtle">
                          <div className="absolute inset-0 bg-gradient-to-t from-rich-brown/30 to-transparent z-10"></div>
                          <img 
                            src="/images/chocolate-almond-butter.jpg" 
                        ...
                        <div className="absolute -top-10 -right-6 bg-white p-2 rounded-lg shadow-lg transform -rotate-6 hover:rotate-0 transition-all duration-300 border-2 border-golden-yellow animate-float-slow-reverse w-28 h-28 overflow-hidden">
                          <img src="/images/cashew-butter.jpg" alt="Cashew Butter" className="w-full h-full object-cover rounded" />
                        </div>
                  ...
                  <div className="bg-white py-16">
                    <div className="container mx-auto px-4">
                      <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-rich-brown mb-4">Our Featured Products</h2>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <HomeFeaturedProductCard 
                          product={{
                            ...
                            price: 1050,
                            image: '/images/chocolate-macadamia-butter.jpg',
                            rating: 4.9,
                            reviews: 42,
                            variants: [{ mass: 370, price: 1050 }]
                          }}
                          addToCart={addToCart}
                        />
                  ...
                  <div className="bg-warm-beige py-16">
                    <div className="container mx-auto px-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                          <div className="h-48 overflow-hidden">
                            <img src="/images/cashew-butter.jpg" alt="Cashew Butters" className="w-full h-full object-cover transition-transform duration-500 hover:scale-110" />
                          </div>
                          <div className="p-6">
        ...
        <ToastContainer 
          ...
          toastClassName="toast-slim"
          bodyClassName="toast-body-slim"
          limit={3}
          icon={false}
          enableMultiContainer={false} // Ensures only one container instance is active
          containerId="main-toast-container" // Unique ID for this container
          style={{
            width: 'auto',
            maxWidth: '320px',
            padding: '0',
            bottom: '80px', // Positioned above mobile navigation
            right: '16px'
          }}
          transition={Slide}
          stacked

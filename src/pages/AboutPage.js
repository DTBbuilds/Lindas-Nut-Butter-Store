    ...
    <div className="about-page">
      ...
      <section className="relative overflow-hidden py-16 md:py-28 min-h-[80vh] flex items-center">
        ...
        <div className="absolute top-0 right-0 w-1/3 h-1/3 opacity-25 z-5 animate-pulse">
          <img src={fixImagePath("/images/pattern-dots.png")} alt="" className="w-full h-full object-contain rotate-12" />
        </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
                ...
                <div className="relative rounded-xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1 mx-auto max-w-sm sm:max-w-md md:max-w-full border-4 border-[#f3c06b]/20">
                  <div className="aspect-w-4 aspect-h-3 bg-[#f8d49a]/20">
                    <img 
                      ...
                      alt="Delicious chocolate hazelnut butter - one of our premium products" 
              ...
              <div className="md:col-span-7">
                <div className="bg-gradient-to-br from-[#f8f0e0]/80 to-[#e8e0d0]/60 p-6 sm:p-8 rounded-xl shadow-lg border border-[#f3c06b]/20">
                  <h3 className="text-2xl font-bold text-[#6b4423] mb-4 border-b-2 border-[#f3c06b]/30 pb-2">From a humble Nairobi kitchen to Kenya's celebrated artisanal nut butter brand</h3>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-[#f8d49a]/30 p-5 rounded-xl border border-[#e89d3e]/20 transform hover:scale-102 transition-transform flex items-center">
                      <div className="bg-white p-3 rounded-full shadow-md mr-4">
                        <FontAwesomeIcon icon={faMapMarkerAlt} className="text-[#a36b35] text-xl" />
                      </div>
                      <div>
                        <h4 className="font-bold text-[#6b4423]">Born in Nairobi, Raised by Kenya</h4>
                        <p className="text-sm text-[#6b4423]/80">From local markets to national treasure</p>
                      </div>
                    </div>
                    
                    <div className="bg-[#f8d49a]/30 p-5 rounded-xl border border-[#e89d3e]/20 transform hover:scale-102 transition-transform flex items-center">
                      <div className="bg-white p-3 rounded-full shadow-md mr-4">
                        <FontAwesomeIcon icon={faAward} className="text-[#a36b35] text-xl" />
                      </div>
                      <div>
                        <h4 className="font-bold text-[#6b4423]">Est. 2018</h4>
                        <p className="text-sm text-[#6b4423]/80">Growing with quality and purpose</p>
                      </div>
                    </div>
                  </div>
                  
                  <div className="text-center py-6">
                    <div className="w-1 h-12 bg-gradient-to-b from-[#a36b35] to-[#f3c06b] mx-auto mb-4 rounded-full"></div>
                    
                    <a href="#journey" className="inline-flex items-center bg-[#a36b35] hover:bg-[#8b5a30] transition-colors duration-300 text-white font-bold py-4 px-8 rounded-full shadow-lg transform hover:scale-105 transition-transform">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 hover:-translate-y-2 hover:shadow-xl">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-3 text-rich-brown">Local Supply Chain Excellence</h3>
                  <p className="text-gray-600 leading-relaxed">Our business thrives on partnerships with small-scale Kenyan farmers across Nyeri, Muranga, and Kiambu counties. This direct-sourcing model ensures exceptional quality control, reduces transportation costs, and allows us to maintain consistent product quality year-round.</p>
                  <div className="mt-4 border-t border-gray-100 pt-4">
                    <span className="text-sm font-medium text-warm-beige bg-warm-beige bg-opacity-20 px-3 py-1 rounded-full">Strategic Partnerships</span>
                    <span className="ml-2 text-sm font-medium text-warm-beige bg-warm-beige bg-opacity-20 px-3 py-1 rounded-full">Quality Control</span>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-12 bg-white p-8 rounded-xl shadow-md">
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-3/4 md:pl-8">
                  <h3 className="text-2xl font-bold text-rich-brown mb-4">Local Sourcing & Business Excellence</h3>
                  <p className="text-gray-700 leading-relaxed">
                    Our business model is strategically built around local Kenyan sourcing. We directly work with small-scale farmers across Nyeri, Muranga, and Kiambu counties, eliminating middlemen and ensuring quality control from farm to jar. This approach has reduced our procurement costs by 22% while delivering premium-grade nuts that meet our exacting standards.
                  </p>
                  
                  {/* Business impact statistics box */}
                  <div className="bg-gradient-to-r from-[#f8f0e0] to-[#f3c06b]/20 p-4 rounded-lg my-4 border border-[#e89d3e]/20 shadow-sm">
                    <h4 className="font-bold text-[#6b4423] mb-2 border-b border-[#e89d3e]/30 pb-2">Our Local Sourcing Impact</h4>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
                      <div className="bg-white/60 p-3 rounded-lg">
                        <div className="text-[#a36b35] text-2xl font-bold">85%</div>
                        <div className="text-[#6b4423] text-sm">Locally sourced ingredients</div>
                      </div>
                      <div className="bg-white/60 p-3 rounded-lg">
                        <div className="text-[#a36b35] text-2xl font-bold">22%</div>
                        <div className="text-[#6b4423] text-sm">Reduced procurement costs</div>
                      </div>
                      <div className="bg-white/60 p-3 rounded-lg">
                        <div className="text-[#a36b35] text-2xl font-bold">200+</div>
                        <div className="text-[#6b4423] text-sm">Partner farming families</div>
                      </div>
                      <div className="bg-white/60 p-3 rounded-lg">
                        <div className="text-[#a36b35] text-2xl font-bold">48hr</div>
                        <div className="text-[#6b4423] text-sm">Farm-to-production time</div>
                      </div>
                    </div>
                  </div>
                  
                  <p className="text-gray-700 leading-relaxed">
                    Our vertically integrated approach extends beyond procurement. We've invested in local processing facilities, reducing transportation costs and carbon footprint while ensuring nuts are processed within 48 hours of harvest—preserving peak freshness and nutritional value that directly translates to superior product quality and customer satisfaction.
                  </p>
                  <a href="#" className="inline-flex items-center mt-4 text-[#a36b35] hover:text-[#6b4423] bg-[#f8d49a]/20 px-4 py-2 rounded-full font-medium transition-colors duration-300">
                    View our business partnerships <FontAwesomeIcon icon={faChevronRight} className="ml-2" />
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden">
            ...
            <div className="flex justify-center items-center bg-soft-green bg-opacity-10 overflow-hidden p-4 sm:p-6">
              <img 
                ...
                onError={(e) => e.target.src = 'https://via.placeholder.com/900x500/F5E8C7/5C4033?text=Linda\'s+Team'}
              />
            </div>
